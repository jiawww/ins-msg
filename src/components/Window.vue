...
<template>
  <div class="window">
    ...
    <button @click="getPosition">获取我的位置</button>
    <button @click="showPosition">显示我的位置</button>
    <button @click="nativePosition">原生方法获取位置</button>
  </div>
</template>
...
export default {
  ...
  methods: {
    send(val) {
      ...
      let url = "http://47.105.41.30:5000/";
